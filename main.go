...
func main() {
	...
	//RecursivePower
	// fmt.Println(functions.RecursivePower(-7, -2))
	// fmt.Println(functions.RecursivePower(-8, -7))
	// fmt.Println(functions.RecursivePower(4, 8))
	// fmt.Println(functions.RecursivePower(1, 3))
	// fmt.Println(functions.RecursivePower(-1, 1))
	// fmt.Println(functions.RecursivePower(-6, 5))

	//PrintCombn
	// functions.PrintCombN(1)
	// functions.PrintCombN(2)
	// functions.PrintCombN(3)
	// functions.PrintCombN(4)
	// functions.PrintCombN(5)
	// functions.PrintCombN(6)
	// functions.PrintCombN(7)
	// functions.PrintCombN(8)
	...
	//AtoiBase
	// fmt.Println(functions.AtoiBase("bcbbbbaab", "abc"))
	// fmt.Println(functions.AtoiBase("uoi", "choumi"))
	// fmt.Println(functions.AtoiBase("bbbbbab", "-ab"))
	// fmt.Println(functions.AtoiBase("125", "0123456789"))
	...
	// fmt.Println(functions.Split(sa, "!==!"))
	...
	// functions.AdvancedSortWordArr(result4, functions.Compare1)
	// fmt.Println(result4)
	// result5 := []string{"\"digits\"", "The", "comesfrom", "digital", "fingers", "or", "word"}
	// functions.AdvancedSortWordArr(result5, functions.Compare1)
	// fmt.Println(result5)
	// result6 := []string{"1", "2", "3", "A", "B", "C", "a", "b", "c"}
	// functions.AdvancedSortWordArr(result6, functions.Compare1)
	// fmt.Println(result6)

	//ActiveBits
	// fmt.Println(functions.ActiveBits(15))
	// fmt.Println(functions.ActiveBits(17))
	// fmt.Println(functions.ActiveBits(4))
	// fmt.Println(functions.ActiveBits(11))
	// fmt.Println(functions.ActiveBits(9))
	// fmt.Println(functions.ActiveBits(12))
	// fmt.Println(functions.ActiveBits(2))

	//SortList
	// var link *functions.NodeI
	// link = functions.ListPushBackNodeI(link, 1)
	// link = functions.ListPushBackNodeI(link, 2)
	// link = functions.ListPushBackNodeI(link, 3)
	// link = functions.ListPushBackNodeI(link, 4)
	// link = functions.ListPushBackNodeI(link, 5)
	// link = functions.ListPushBackNodeI(link, 24)
	// link = functions.ListPushBackNodeI(link, 25)
	// link = functions.ListPushBackNodeI(link, 54)
	// functions.PrintList(link)
	// link = functions.SortListInsert(link, 33)
	// functions.PrintList(link)
	...
	// link = functions.ListPushBackNodeI(link, 0)
	// link = functions.ListPushBackNodeI(link, 7)
	// link = functions.ListPushBackNodeI(link, 39)
	// link = functions.ListPushBackNodeI(link, 92)
	// link = functions.ListPushBackNodeI(link, 97)
	// link = functions.ListPushBackNodeI(link, 93)
	// link = functions.ListPushBackNodeI(link, 91)
	// link = functions.ListPushBackNodeI(link, 28)
	// link = functions.ListPushBackNodeI(link, 64)

	// link2 = functions.ListPushBackNodeI(link2, 80)
	// link2 = functions.ListPushBackNodeI(link2, 92)
	// link2 = functions.ListPushBackNodeI(link2, 27)
	// link2 = functions.ListPushBackNodeI(link2, 30)
	// link2 = functions.ListPushBackNodeI(link2, 85)
	// link2 = functions.ListPushBackNodeI(link2, 81)
	// link2 = functions.ListPushBackNodeI(link2, 75)
	// link2 = functions.ListPushBackNodeI(link2, 70)

	// functions.PrintList(functions.SortedListMerge(link2, link))

	//ListRemoveIf
	// link := &functions.List{}
	// functions.ListPushBackNodeL(link, 98)
	// functions.ListPushBackNodeL(link, 98)
	// functions.ListPushBackNodeL(link, 33)
	// functions.ListPushBackNodeL(link, 34)
	// functions.ListPushBackNodeL(link, 33)
	// functions.ListPushBackNodeL(link, 34)
	// functions.ListPushBackNodeL(link, 33)
	// functions.ListPushBackNodeL(link, 89)
	// functions.ListPushBackNodeL(link, 33)
	// functions.PrintListL(link)
	// functions.ListRemoveIf(link, 34)
	// functions.PrintListL(link)

	//BTreeTransplant
	// root := &functions.TreeNode{Data: "01"}
	// functions.BTreeInsertData(root, "07")
	// functions.BTreeInsertData(root, "12")
	// functions.BTreeInsertData(root, "10")
	// functions.BTreeInsertData(root, "05")
	// functions.BTreeInsertData(root, "02")
	// functions.BTreeInsertData(root, "03")
	// node := functions.BTreeSearchItem(root, "12")
	// replacement := &functions.TreeNode{Data: "55"}
	...
	// functions.BTreeInsertData(root, "02")
	// functions.BTreeInsertData(root, "03")
	// node := functions.BTreeSearchItem(root, "02")
